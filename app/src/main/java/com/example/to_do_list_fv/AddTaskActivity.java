            ...
            if (radioButton != null && !findInvalidInput() && due_date != null) {
                ...
                mDatabase.child("users").child(email_parts[0]).child("tasks").
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.exists() && title != null && !title.getText().equals("")) {
                            // if the task title exists then show a error
                            TextInputLayout textInputLayout = findViewById(R.id.task_title);
                            textInputLayout.setHint("");
                            title.setHint("Title is Taken!");
                            ...
                            Intent intent = new Intent(AddTaskActivity.this, SuccessMessage.class);
                            startActivity(intent);
                        }
                    }
